...
export const TerminosComponent = () => {
  ...
  return <div style={{ color: 'black', fontSize: '18px' }}>
    ...
    <p>Los t&eacute;rminos en Prolog son la unidad b&aacute;sica de construcci&oacute;n utilizada para representar los datos en el programa. A su vez, los t&eacute;rminos pueden estar formados por &aacute;tomos, variables y estructuras.</p>
<ul>
...
<ul>
<li><strong>Variable: </strong>Las variables en Prolog deben empezar con may&uacute;scula o con&nbsp;<strong>&lsquo;_&rsquo;</strong>.</li>
</ul>
...
<p>Por ejemplo, para la estructura persona(juan, 25, ingeniero), "persona" es el functor, y sus t&eacute;rminos son "juan", "25", e "ingeniero". Esta estructura podr&iacute;a representar informaci&oacute;n sobre una persona, donde "juan" es el nombre, "25" es la edad, y "ingeniero" es su profesi&oacute;n.</p>
