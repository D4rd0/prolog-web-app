...
<p>donde <em>h</em> es la <strong>cabeza</strong> de la cl&aacute;usula y q<sub>1</sub>, q<sub>2</sub>, &hellip;, q<sub>n</sub> es el <strong>cuerpo</strong>.</p>
...
<p>Un ejemplo de cl&aacute;usulas es el siguiente:</p>

<div dangerouslySetInnerHTML={{ __html: htmlContent }} />

<p>La regla del programa anterior reescrita al lenguaje natural se leer&iacute;a de la siguiente manera:</p>
