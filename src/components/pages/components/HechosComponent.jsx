...
<p>donde el predicado es un functor que describe una propiedad o relaci&oacute;n y los argumentos t<sub>1</sub>, t<sub>2</sub>, &hellip;, t<sub>n</sub> son t&eacute;rminos. Los hechos pueden emplearse de varias formas:</p>
<ul>
