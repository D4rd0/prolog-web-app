...
export const IntroduccionComponent = () => {
  ...
  return <div style={{ color: 'black', fontSize: '18px' }}>
    ...
    <p>Prolog, abreviatura de "Programming in Logic", es un lenguaje de programaci&oacute;n l&oacute;gica que a diferencia de los lenguajes convencionales como C++ o Java, sigue un paradigma declarativo, donde los programas se estructuran alrededor de reglas l&oacute;gicas y relaciones.</p>
...
<p>Para responder a las preguntas o consultas formuladas por el programador, Prolog consulta una base de conocimiento, &eacute;sta representa el programa como tal, que se compone &uacute;nicamente de cl&aacute;usulas, que con el uso de la l&oacute;gica expresan el conocimiento representado en el programa.</p>
<h2>Programa</h2>
<p>Un programa en Prolog est&aacute; compuesto por un conjunto de cl&aacute;usulas, que pueden ser hechos o reglas, organizadas de manera que el int&eacute;rprete de Prolog pueda utilizarlas para responder consultas.</p>
...
<h2>Inferencia</h2>
<p>La inferencia es el proceso mediante el cual el int&eacute;rprete de Prolog deduce soluciones a partir de las reglas y hechos definidos en el programa. La inferencia en Prolog se basa en el uso de la l&oacute;gica de primer orden y el mecanismo de resoluci&oacute;n.</p>
...
<p>Por ejemplo, el siguiente programa define una relaci&oacute;n padre y una regla para determinar si alguien es abuelo:</p>
...
<p>En este caso, las cl&aacute;usulas tienen el mismo predicado hijo en el &aacute;tomo de la cabeza, por lo que todas estas cl&aacute;usulas forman parte de la definici&oacute;n del predicado hijo.</p>
